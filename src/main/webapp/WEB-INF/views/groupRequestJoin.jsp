...
<form:form modelAttribute="rootData" action="${pageContext.request.contextPath}/group/reqJoin/exec" id="mainForm">
	<div id="main">
		...
		<div>
			...
			<form:select path="group.slctGroupId" onchange="pullDownSelect(this, '${pageContext.request.contextPath}/group/reqJoin/tmp')">
				<option value="">
		...
		<input type="button" value="REQ TO JOIN!!" id="groupCreateBtn" onclick="submitProc('mainForm')">
		<br><br><br>
